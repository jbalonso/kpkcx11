...
#ifndef _PKCS11_GLOBALS_H_
#define _PKCS11_GLOBALS_H_

#ifdef WIN32
#include "win32pre.h"
#endif

extern PKCS11_MODULE *PKCS11_ModulePtr;
extern CK_OBJECT_HANDLE PKCS11_ObjectHandleCounter;

#ifdef WIN32
#include "win32post.h"
#endif

#endif /* _PKCS11_GLOBALS_H_ */
