...
#ifndef _CKI_GLOBALS_H_
#define _CKI_GLOBALS_H_

#ifdef WIN32
#include "win32pre.h"
#endif

extern CK_ULONG PKCS11_ModuleInitDone;
extern CK_FUNCTION_LIST_PTR PKCS11_FunctionListPtr;

#ifdef WIN32
#include "win32post.h"
#endif

#endif /* _CKI_GLOBALS_H_ */
