...
CK_RV PKCS11_Init_Session(CK_SESSION_HANDLE ulSessionHandle, CK_STATE state, CK_FLAGS flags, PKCS11_SESSION *pSession);
CK_RV PKCS11_Init2_Session(CK_SESSION_HANDLE ulSessionHandle, CK_STATE state, CK_FLAGS flags, PKCS11_SESSION *pSession);
