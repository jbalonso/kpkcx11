...
/* this default sucks. please change it. */
#define  DEFAULTRANDFILE "/var/adm/pacct"

/* frankly so do these paths; please change them and move
   the cert and key elsewhere. */
#ifdef WIN32
#define  DEFAULTCERTFILE "c:\\temp\\testcacert.pem"
#define  DEFAULTKEYFILE "c:\\temp\\testcakey.pem"
#else
#define  DEFAULTCERTFILE "/var/https/test/ssl/clientca.crt"
#define  DEFAULTKEYFILE "/var/https/test/ssl/clientca.key"
#endif /* WIN32 */
